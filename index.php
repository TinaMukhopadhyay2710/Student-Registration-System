...
//Insert data into the student data tabel
  	$insert_data = "INSERT INTO student_data(u_card, u_f_name, u_l_name, u_father, u_birthday, u_gender, u_email, u_phone, u_state, u_dist, u_address, u_pincode, staff_id,image,uploaded) VALUES ('$u_card','$u_f_name','$u_l_name','$u_father','$u_birthday','$u_gender','$u_email','$u_phone','$u_state','$u_dist','$u_address','$u_pincode','$u_staff_id','$image',NOW())";
...
<body>
	...
	<div class="container">
<a href="https://lexacademy.in" target="_blank">
...
?>
	...
	<br><a href="logout.php" class="btn btn-success"><i class="fa fa-lock"></i> Logout</a><br>
	<br><button class="btn btn-success" type="button" data-toggle="modal" data-target="#myModal">
...
<input type="text" class="form-control" name="user_father" placeholder="Enter Father Name">
</div>
		...
		<div class='modal-dialog'>
			...
			<div class='container' id='profile'> 
				<div class='row'>
					...
					<div
						<i class='fa fa-id-card' aria-hidden='true'></i> $card<br>
						<i  aria-hidden='true'></i> $phone  <br>
					</div>
					<div class='col-sm-3 col-md-6'>
						<h3 class='text-primary'>$name $name2</h3>
						<p class='text-secondary'>
						 $father <br>
						<i aria-hidden='true'></i> $gender
						<br />
						<i  aria-hidden='true'></i> $email
						<br />
						</div>
  ...
  <div class='modal-dialog'>
    ...
    <div class='modal-content'>
      ...
      <div class='modal-body'>
		...
		<div class='form-group'>
		<label for='inputAddress'>Address</label>
		<input type='text' class='form-control' name='address' placeholder='Enter the address' value='$address'>
		</div>
